            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        <div class="card-head">
                            <header>Update ToDos</header>

                        </div>
                        <div class="card-body" id="bar-parent2">
                            <form action="{{route('Todo.update',$Todo->id)}}" method="post" id="form_sample_2" class="form-horizontal"  enctype="multipart/form-data" autocomplete="on">
                                {{csrf_field()}}
                                ...
                                <div class="form-body">
                                    ...
                                    {{--End--}}
                                    {{--Assigned date--}}
                                    <input type="hidden" class="form-control" value="{{@$Todo->assignedDate}}"
                                ...
                                {{--Status--}}
                                <div>
                                    <input type="hidden" class="form-control" value="{{@$Todo->status}}"
                                ...
                                {{--End--}}
                                    <div class="form-group">
                                        <div class="offset-md-3 col-md-9">
                                            ...
                                            <a class="btn btn-default" href="{{route('Todo.index')}}">Cancel</a>
                                        </div>
                                    </div>
                            </form>
                        </div>
