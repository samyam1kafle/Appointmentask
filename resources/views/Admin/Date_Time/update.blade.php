            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        <div class="card-head">
                            <header>Update New Date</header>

                        </div>
                        <div class="card-body" id="bar-parent2">
                            <form action="{{route('Date_Time.update',$date_time->id)}}" method="post" id="form_sample_2">
                            {{csrf_field()}}
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row margin-top-20">
                                        ...
                                        <div class="input-append date form_date" data-date-format="yy-m-d H:i:s"
                                            ...
                                            <input size="30" type="text" required name="date" value="{{$date_time->date}}">
                                    ...
                                    <div class="form-group row margin-top-20">
                                        ...
                                        <div class="input-append date timepicker-orient-bottom form_time">
                                            <input size="30" type="text" value="{{$date_time->time}}" required name="time">
                                            <span class="add-on"><i class="fa fa-remove icon-remove"></i></span>
                                    ...
                                    <div class="form-group">
                                        <div class="offset-md-3 col-md-9">
                                            ...
                                            <a class="btn btn-default" href="{{route('Date_Time.index')}}">Cancel</a>
                                        </div>
                                    </div>
                            </form>
                        </div>
