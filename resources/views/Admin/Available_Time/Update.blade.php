            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li><a class="parent-item" href="">Available Time</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        <div class="card-head">
                            <header>Update Time</header>

                        </div>
                        <div class="card-body" id="bar-parent2">
                            <form action="{{route('AvailableTime.update', $time->id)}}" method="post" id="form_sample_2" class="form-horizontal"  enctype="multipart/form-data" autocomplete="on">
                                {{csrf_field()}}
                                ...
                                <div class="form-body">
                                    <div class="form-group row margin-top-20">
                                        ...
                                        <div class="input-append timepicker-orient-bottom ">
                                            <select class="form-control col-12 input-append  " name="date_id">
                                                <option value="{{$time->Date_Available['date']}}" disabled selected hidden>{{$time->Date_Available['date']}}</option>
                                                @if($date)
                                    ...
                                    <div class="form-group row margin-top-20">
                                        ...
                                        <div class="input-append date timepicker-orient-bottom form_time">
                                            <input size="30" type="text" value="{{$time->time}}" name="time" readonly>
