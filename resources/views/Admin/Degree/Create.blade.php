            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        <div class="card-head">
                            <header>Add New Degree</header>

                        </div>
                        <div class="card-body" id="bar-parent2">
                            <form action="{{route('Degree.store')}}" id="form_sample_2" class="form-horizontal"
                                  method="post"
                                  autocomplete="on">
                                {{csrf_field()}}
                                        ...
                                        <div class="form-group row  margin-top-20">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" name="degree_name" required/></div>
                                            </div>
                                        </div>
                                    </div>
